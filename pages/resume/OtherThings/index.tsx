...
import {FaBookOpen, FaCube, FaFootballBall, FaResearchgate} from "react-icons/fa"
import { GrCubes } from "react-icons/gr";
import { HiBookOpen, HiCodeBracket, HiCube, HiOutlinePuzzlePiece } from "react-icons/hi2";
  ...
  return (
    <Stack gap="2rem" flexDir="column" color="#f3f3f3">
      ...
      <Stack>
        ...
        <Text textTransform="capitalize" fontSize={18} lineHeight={10} width="400px">
        ...
        <HStack gap="1rem" alignItems="center">
          {hobbies.map((item, idx)=>(
            <HStack key={idx} textTransform="capitalize">
              <Box color="#fff" fontSize={25} border="1.5px solid #f3f3f3" rounded="full" p="6px">{item.icon}</Box>
              <Text>{item.name}</Text>
            </HStack>
          ))}
          </HStack>
